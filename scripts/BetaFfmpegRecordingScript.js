...
const StartPreRecordSession = async () => {
  ...
  const HandlerCombinedStream = new MediaStream()
  HandlerCombinedStream.addTrack(HandlerVideoTrack)
  HandlerCombinedStream.addTrack(HandlerAudioTrack)
  const RecorderMedia = new MediaRecorder(HandlerCombinedStream, { mimeType: 'video/webm;codecs=h264' })
  var TemporaryFrames = []
